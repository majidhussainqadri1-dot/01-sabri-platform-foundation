...
No unresolved blocker/critical product-code defect is knowingly accepted in the reviewed **2.0.0 repository candidate scope** after the latest completed corrective round. This statement is repository-scoped, not a live-system assertion. The following remain external evidence gates rather than automatically satisfied by source/CI:
